...
class RouteGuideStub(object):
    ...
    Simple RPC:
    client sends a request to the server using stub and waits for response to come back, just like normal function call 
    """
...
class RouteGuideServicer(object):
    ...
    def ListFeatures(self, request, context):
        """
        Server-to-client streaming (response-streaming) RPC:
        Clients sends a request to the server and gets a stream to read a sequence of messages back. 
        Client reads from the stream until there are no messages. 
    ...
    def RecordRoute(self, request_iterator, context):
        """
        Client-to-server (request-streaming) streaming RPC:
        Client writes a sequence of messages and sends them to the server. 
        Once clieent finish writing, it waist for server to read them all and return its response. 
    ...
    def RouteChat(self, request_iterator, context):
        ...
        Both sides send sequence of messages using read-write stream. They're independent. Client and Server can read and write in whatever order. 
